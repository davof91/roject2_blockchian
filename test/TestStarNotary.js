...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(name+"-"+symbol, 'StarLord-SLD');
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let user1 = accounts[2];
    let starId = 9;
    await instance.createStar('Best Start Ever', starId, {from: user1});
    assert.equal(await instance.lookUptokenIdToStarInfo(starId), 'Best Start Ever');
});